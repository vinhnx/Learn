...
#import "NXVMasterViewController.h"
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    FailedBankInfo *failedBankInfo = [NSEntityDescription
                                      insertNewObjectForEntityForName:kFailedBankInfo
    ...
    FailedBankDetails *failedBankDetails = [NSEntityDescription
                                            insertNewObjectForEntityForName:kFailedBankDetails
                                            inManagedObjectContext:context];
    ...
    NXVMasterViewController *controller = (NXVMasterViewController *)navigationController.topViewController;
